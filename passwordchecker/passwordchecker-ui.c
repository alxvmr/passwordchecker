          ...
          gpointer        user_data)
{
    ...
    gtk_builder_add_from_file (builder, "/home/user/Develop/passwordchecker/data/ui/passwordchecker-gnome-window.ui", &error);
    if (error){
    ...
    gtk_builder_add_from_file (builder, "/home/user/Develop/passwordchecker/data/ui/passwordchecker-gnome-switcher.ui", &error);
    if (error){
        g_printerr("Error loading Glade file: %s\n", error->message);
        g_clear_error(&error);
        return;
    ...
    gtk_builder_add_from_file (builder, "/home/user/Develop/passwordchecker/data/ui/passwordchecker-gnome-page-app.ui", &error);
    if (error){
        g_printerr("Error loading Glade file: %s\n", error->message);
        g_clear_error(&error);
        return;
